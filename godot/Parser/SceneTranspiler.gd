...
class DialogueNode:
	...
	func _init(next: int, line: String) -> void:
		super(next)
		self.next = next
		self.line = line
...
class BackgroundCommandNode:
	...
	func _init(next: int, background: String) -> void:
		super(next)
		self.next = next
...
class SceneCommandNode:
	...
	func _init(next: int, scene_path: String) -> void:
		super(next)
		self.next = next
...
class TransitionCommandNode:
	...
	func _init(next: int, transition: String) -> void:
		super(next)
		self.next = next
...
class ChoiceTreeNode:
	...
	func _init(next: int, choices: Array) -> void:
		super(next)
		self.next = next
...
class ConditionalBlockNode:
	...
	func _init(next: int, condition: SceneParser.BaseExpression) -> void:
		super(next)
		self.next = next
...
class ConditionalTreeNode:
	...
	func _init(next: int, if_block: ConditionalBlockNode) -> void:
		super(next)
		self.next = next
...
class SetCommandNode:
	...
	func _init(next: int, symbol: String, value) -> void:
		super(next)
		self.next = next
		self.symbol = symbol
		self.value = value
